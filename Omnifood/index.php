...
<html lang="en">
     <head>
         ...
         <meta name="description" content="Omnifood is a premium food delivery services with the mission to bring affordable and healthy meals to as many people as possible">
           ...
           <div class="row">
               ...
               <div class="works-step">
                ...
                <div>3</div>
                   ...
                   <a href="a" class="btn-app"><img src="resources/img/download-app-android.png" alt="App Store Button"></a>
...
<h3>Starter</h3>
   <p class="plan-price j">$19 <span>/ per meal</span></p>
    ...
    <footer>
        ...
        <div class="row">
            <div class="col span-1-of-2">
                ...
                <li><a href="a">Andriod App</a></li>
                </ul>
            </div>
            <div class="col span-1-of-2">
                <ul class="social-links">
                <li><a href="a"><i class="ion-social-facebook"></i></a></li>
                <li><a href="a"><i class="ion-social-twitter"></i></a></li>
                <li><a href="a"><i class="ion-social-googleplus"></i></a></li>
                <li><a href="a"><i class="ion-social-instagram"></i></a></li>
                </ul>
            </div>
        </div>
        <div class="row">
        <p>
            Copyright &copy; 2017 by Omnifood. All rights reserved.</p></div>
    </footer>
